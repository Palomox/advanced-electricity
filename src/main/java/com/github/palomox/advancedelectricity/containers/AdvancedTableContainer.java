...
public class AdvancedTableContainer extends Container {
	...
	public AdvancedTableContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory,
			PlayerEntity player) {
		...
		tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
			...
			addSlot(new SlotItemHandler(h, 2, 84, 24));
			addSlot(new SlotItemHandler(h, 3, 64, 44));
			addSlot(new SlotItemHandler(h, 4, 64, 4));
			
			//output
			addSlot(new SlotItemHandler(h, 5, 134, 24));
		});
